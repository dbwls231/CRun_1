...
Rect AnimationRenderer::GetRealArea()
{
	return Rect();
}
...
AnimationRenderer* AnimationRenderer::Play()
{
	defaultData.SetNowIndex(0);

	return this;
}

AnimationRenderer* AnimationRenderer::PushTextures(Textures textures)
{
	defaultData.PushTextures(textures);

	return this;
}

AnimationRenderer* AnimationRenderer::PushTextures(const std::string& path) {
	defaultData.PushTextures(path);
